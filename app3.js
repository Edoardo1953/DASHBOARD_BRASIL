...
// Auth Config
// UTENTI DI DEFAULT ├óÔé¼ÔÇØ questi sono visibili su TUTTI i dispositivi.
...
// ├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼ GITHUB AUTO-SYNC ├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼├óÔÇØÔé¼
...
async function syncToGitHub(usersObj) {
    ...
    try {
        ...
        for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
            try {
                ...
                if (newContent === currentContent) {
                    showSyncStatus('success', '\u2705 Utenti gia sincronizzati su GitHub!');
                    return;
                }
                ...
                if (putRes.status === 409 || putRes.status === 422) {
                    ...
                    if (attempt < MAX_RETRIES) {
                        showSyncStatus('loading', `Conflitto SHA, tentativo ${attempt + 1}/${MAX_RETRIES}...`);
        ...
        if (isAuthError) {
            ...
            showSyncStatus('error', '\u26a0\ufe0f Sync GitHub fallita (deploy in corso?). Login locale OK. Riprova tra qualche minuto.');
        }
    }
}
